            ...
            <form action="{{ route('leagues.store') }}" method="post" class="max-w-sm mx-auto mt-8 mb-8">
                ...
                <div class="flex justify-between mt-5 px-3">
                    ...
                    <a href="{{ route('leagues.index') }}"
                        class="mt-4 p-0.5 mb-2 bg-gray-700 hover:bg-green-700 text-white py-2 px-4 rounded">Volver</a>
                    <!-- Send button -->
                    <input type="submit" value="Enviar"
                        class="mt-4 p-0.5 mb-2 bg-gray-700 hover:bg-teal-700 text-white py-2 px-4 rounded">
                </div>
            </form>
        </div>
    </div>
